...
> [golang 客户端示例](https://github.com/coinsky/trade-server/blob/master/examples/websocket_examples.go)

> [响应数据示例](https://github.com/coinsky/trade-server/blob/master/docs/websocket-data-examples.md)
